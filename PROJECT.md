...
- ポーズメニューは最終的に盤面中央付近へウィンドウ枠を表示し、その内側に項目テキストを表示する。
...
- [ ] UI・追加仕様
  ...
  - [ ] プレイ中のSTART操作
    ...
    - [ ] ポーズメニュー枠画像作成
      - [ ] ウィンドウ枠用PNGを作成する
      - [ ] 枠、角、内側塗りつぶし用タイルを用意する
      - [ ] 画像タイルはPNGから生成する
    - [ ] ポーズメニュー枠表示処理
      - [ ] ポーズメニュー表示時にウィンドウ枠を表示する
      - [ ] ウィンドウ枠の内側にRESUME / RESTART / BACK TO TITLEを表示する
      - [ ] 選択中項目を `>` で表示する
      - [ ] RESUME時にウィンドウで隠した盤面を復元する
    - [ ] ポーズ解除時の一括再描画
